...
import (
	...
	"singlishwords/model"
	anwser_service "singlishwords/service/answer"
	"strconv"
...
func GetAnswers(c *gin.Context) (code status.Code, questions interface{}) {
	...
	// questions, err = service.GetQuestions(limit)
	if err != nil {
		code = status.Fail("Query parameter limit should be int.")
		return
	}
...
func PostAnswers(c *gin.Context) (status.Code, interface{}) {
	err := anwser_service.PostAnswers()
	if err != nil {
...
// func GetAllAnswersInCSV(c *gin.Context) {
// 	c.JSON(http.StatusOK, "TODO, Return all Answers")
// }
